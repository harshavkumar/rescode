...
model=tflearn.DNN(net, checkpoint_path='./DeXpression/checkpoints',
...
# give version to model
version = "2"
# Save the model
model.save('./DeXpression/checkpoints/' + version + '.model')

# Load the model if required, later.
#model.load('./DeXpression/checkpoints/' + RUNID + '.model')